...
<body>
    <form id="edit-profile" modelAttribute="pointType" class="form-horizontal" action="/pt/update" enctype="multipart/form-data" method="post">
        <fieldset>
            <div class="form-group">
                <label class="control-label col-sm-2" for="name">类型名称</label>
                <div class="col-sm-8">
                    <input class="form-control" id="name" name="name"  type="text" required value="${type.name}">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <img src='${ctx.contextPath}/ps/previewPath?path=${type.url!''}' width='50' height='50'/>
