                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><input type="text" class="form-control input-sm"
                                       name="extendList[${key_index}].geoPeriod" value="${key.geoPeriod}" readonly/>
                            </td>
                            <td><input type="text" class="form-control input-sm"
                                       name="extendList[${key_index}].geoFloor" value="${key.geoFloor}" readonly/></td>
                            <td><input type="text" class="form-control input-sm"
                                       name="extendList[${key_index}].rockProperty" value="${key.rockProperty}"
                                       readonly/></td>
                            <td><input type="text" class="form-control input-sm"
                                       name="extendList[${key_index}].geoEnviroment" value="${key.geoEnviroment}"
                                       readonly/></td>
                            <td><input type="text" class="form-control input-sm"
                                       name="extendList[${key_index}].geoEvent" value="${key.geoEvent}" readonly/></td>
                            <td><input type="text" class="form-control input-sm" name="extendList[${key_index}].geoLook"
                                       value="${key.geoLook}" readonly/></td>
                        </tr>
                        </#list>
                    </tbody>
                </table>
