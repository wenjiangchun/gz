...
<body>
    <form id="edit-profile" class="form-horizontal" action="/ps/updateP" method="post" enctype="multipart/form-data">
        <fieldset>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr><td>${key.title}</td><td>${key.url}</td>
                            <td>
                              ...
                              <a href="javascript:void(0)" onclick="preview('${key.url}')">预览</a>
            ...
            <div class="form-group">
                <label class="control-label col-sm-2" for="picture">选择照片</label>
                <div class="col-sm-8">
                    <input id="picture" name="picture" type="file" multiple accept=".jpg,.jpeg,.png">
                </div> <!-- /controls -->
            </div>
            <div class="form-group">
