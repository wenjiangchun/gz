          ...
          <div class="widget widget-nopad">
            ...
            <div class="widget-content">
                ...
                <nav aria-label="...">
                    <ul class="pager">
                        <#if previous!>
                            <li><a href="/b?page=${ps.number-1}">上一页</a></li>
                        </#if>
                        <#if next!>
                            <li><a href="/b?page=${ps.number+1}">下一页</a></li>
                        </#if>
                    </ul>
                </nav>
            </div>
...
<script>
    ...
    function searchP() {
        window.location.href="/b?productName="+$("input[name='productName']").val();
    }
