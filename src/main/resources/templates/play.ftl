...
<head>
    ...
    <title></title>
    <link rel="stylesheet" type="text/css" href="${ctx.contextPath}/res/flv/default.css"/>
</head>
    ...
    <div>
        <div id="streamURL">
            <div class="url-input" style="display:none">
                <label for="sURL1">播放路径:</label>
                <input id="sURL1" type="input"
                       value="${ctx.contextPath}/ps/download?parentPath=${parentPath}/${name}&fileName=${name}"
                       readonly/>
...
<script src="${ctx.contextPath}/res/flv/flv.js"></script>

<script>
    var checkBoxFields = ['isLive', 'withCredentials', 'hasAudio', 'hasVideo'];
    var streamURL = '${ctx.contextPath}/ps/download?parentPath=${parentPath}/${name}&fileName=${name}';
    var mediaSourceURL;
    ...
    function saveSettings() {
        ...
        var sURL = document.getElementById('sURL1');
        ls_set('msURL', msURL.value);
        ls_set('sURL', streamURL);
        console.log('save');
    }
    ...
    function loadSettings() {
        ...
        sURL.value = ls_get('sURL', streamURL);
